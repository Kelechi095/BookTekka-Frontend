  ...
  return (
    <nav className='border-2 shadow-2xl fixed bottom-0 w-full lg:hidden'>
        <ul className='px-4 py-1 bg-white w-full flex justify-between '>
            <li className={currentPage === '' ? 'cursor-pointer flex flex-col items-center text-black' : 'cursor-pointer flex flex-col items-center text-gray-400'}>
                <MdMenuBook size={25}/>
                <span className={'font-semibold text-xs'}>Library</span>
            </li>
            <li className={currentPage === 'Recommendation' ? 'cursor-pointer flex flex-col items-center text-black' : 'cursor-pointer flex flex-col items-center text-gray-400'}>
                <BsPeopleFill size={25} />
                <span className='font-semibold text-xs '>Recommendation</span>
            </li>
            <li className='cursor-pointer flex flex-col items-center text-gray-400'>
